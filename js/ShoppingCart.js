$(document).ready(function() {
	...
	$(".contextmenu li:eq(1)").toggle(function(){
		$(".chekds").parents(".reg").css("border","1px orange solid").find(".chekds").prop("checked",true);
	},function(){
		$(".chekds").parents(".reg").css("border","1px #ffffff solid").find(".chekds").prop("checked",false);
	})
   ...
   $(".butny").live('click',function(){
	...
	function sty(s) {
		...
		var arr = money + "-" + money;
		setTimeout(function() {
			window.open("meau.html?" + escape(arr));
		}, 1050);
	}
